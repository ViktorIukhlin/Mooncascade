...
const MainPage = () => {
    ...
    const sendingData = () => {
        ...
        for (let i = 0; i < settings.number_athletes; i++) {
            let firstPoint = getRandomNumber(
                settings.start_min,
                settings.start_max
            );
            ...
            setTimeout(() => {
                ...
                let secondPoint = getRandomNumber(
                    settings.finish_min,
                    settings.finish_max
                );
                setTimeout(() => {
        ...
        <div className="wrapper">
            <div className="modal">
                ...
                <div className="modal__label">
                    The time it takes athletes to reach the finish corridor
                </div>
                ...
                <div className="modal__label">
                    The time it takes to overcome the finish corridor
                </div>
                <div className="modal__input-box">
                    <input
                        className="modal__input"
                ...
                <div className="modal__input-box">
                    {!sending ? (
                        ...
                        <div
                            className="modal__button disabled"
                            onClick={sendingData}
                        >
